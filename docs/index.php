...
<html>
    ...
    <div class="block_menu">
        <ul>
        <a href="<?php echo WEBROOT ?>/"><li><i class="fa fa-home" aria-hidden="true"></i>Home</li></a>
        <a href="<?php echo WEBROOT ?>/pages/app-page.php"><li><i class="fa fa-tree" aria-hidden="true"></i>Make A Tree</li></a>
        <a href="<?php echo WEBROOT ?>/pages/what.php"><li><i class="fa fa-question-circle" aria-hidden="true"></i>End User Help</li></a>
        <a href="<?php echo WEBROOT ?>/docs/pages/coderef"><li>Code Reference</li></a>
        <li class="sub_menu" tabindex="1">Software Engineering
            <ul>
            <a href="<?php echo WEBROOT ?>/docs/pages/requirements_list.php"><li>Requirements List</li></a>
            <a href="<?php echo WEBROOT ?>/docs/pages/use_cases.php"><li>Use Cases</li></a>
            <a href="<?php echo WEBROOT ?>/docs/pages/class_analyses.php"><li>Class/method analyses</li></a>
            <a href="<?php echo WEBROOT ?>/docs/pages/class_diagram.php"><li>Class Diagram</li></a>
            <a href="<?php echo WEBROOT ?>/docs/pages/sequence_diagrams.php"><li>Sequence Diagrams</li></a>
            </ul>
        </li>
