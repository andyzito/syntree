...
$html = shell_exec("sudo rst2html.py --no-generator --no-xml-declaration --stylesheet=\"\" " . "./docs/source/base/requirements_list.rst");
$f = fopen("./docs/source/html/requirements_list_source.html", "w");
fwrite($f, strip_html($html));
exec('cp ./docs/source/base/requirements_list.rst ./docs/download/requirements_list.rst');